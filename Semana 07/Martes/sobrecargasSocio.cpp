...
/*
    ...
    * Buscar registro
    ...
    23/09/25
    - LISTAR LOS SOCIOS MAYORES DE EDAD
    - LISTAR SOCIOS ORDENADOS POR APELLIDO
    - INFORMAR SOCIOS QUE TIENEN EMAIL VACIO O "0"
    - LISTAR SOCIOS CON APELLIDO QUE EMPIECE CON LA LETRA B
    - LISTAR SOCIOS MENORES DE EDAD E INACTIVOS
    - LISTAR SOCIOS DE LA LOCALIDAD VL
    - LISTAR SOCIOS QUE SE DIERON DE ALTA EN 2023
...
public:
    ...
    const char* getMail(){return email;}
...
///Métodos de Socio
void SocioViejo::Cargar(int _dni){
    cout<<"IDSOCIO: ";
    cin>>IdSocio;
...
void Socio::operator=(SocioViejo obj){
    DNI=obj.getDniSocio();
    IdSocio=obj.getIdSocio();
    strcpy(nombre, obj.getNombre());
    strcpy(apellido, obj.getApellido());
    strcpy(telefono,obj.getTelefono());
    strcpy(email, obj.getMail());

...
Tarea::Tarea()
:_id(0), _descripcion(""), _fecha(), _IDPersonal(0), _completado(false) {

}

Tarea::Tarea(int id, std::string descripcion, Fecha fecha, int idPersonal, bool completado){
  setID(id);
